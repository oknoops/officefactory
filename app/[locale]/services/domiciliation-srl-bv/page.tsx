...
export async function generateMetadata({
    ...
    return {
        title: t('domiciliation_srl_title'),
        description: t('domiciliation_srl_desc'),
        keywords: t('domiciliation_srl_keywords'),
        alternates: generateAlternates(locale, '/services/domiciliation-srl-bv'),
    };
}

const domiciliationSRLServiceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Domiciliation SRL/BV à Bruxelles',
    provider: {
        '@type': 'LocalBusiness',
        name: 'Office Factory',
        address: {
    ...
    serviceType: 'Business Domiciliation for SRL/BV',
};
    ...
    return (
        <main className="min-h-screen flex flex-col bg-white">
            <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify(domiciliationSRLServiceSchema) }}
            />
            <Navbar />
            ...
            {/* SRL Domiciliation Requirements */}
            ...
            <section className="py-20">
                <div className="container max-w-4xl">
                    <h2 className="text-3xl font-bold mb-8 text-[#1D1D1B] text-center">
                        {t('inc_title')}
                    </h2>
