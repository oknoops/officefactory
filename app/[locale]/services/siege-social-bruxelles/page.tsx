...
export async function generateMetadata({
    ...
    return {
        title: t('siege_social_title'),
        description: t('siege_social_desc'),
        keywords: t('siege_social_keywords'),
        alternates: generateAlternates(locale, '/services/siege-social-bruxelles'),
    };
}

const siegeSocialSchema = {
    ...
    description: 'Établissez votre siège social à Bruxelles. Adresse officielle, gestion du courrier, conformité BCE. Centre agréé SPF Économie.',
    offers: {
        '@type': 'Offer',
        price: '79',
        priceCurrency: 'EUR',
    ...
    return (
        <main className="min-h-screen flex flex-col bg-white">
            <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify(siegeSocialSchema) }}
            />
            <Navbar />
