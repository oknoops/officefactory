...
import { Check, Rocket, ShieldCheck, Zap, ChevronDown } from 'lucide-react';
...
export async function generateMetadata({
    ...
    return {
        title: t('domiciliation_startup_title'),
        description: t('domiciliation_startup_desc'),
        keywords: t('domiciliation_startup_keywords'),
        alternates: generateAlternates(locale, '/services/domiciliation-startups'),
    };
}

const domiciliationStartupServiceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Domiciliation pour startups à Bruxelles',
    provider: {
        '@type': 'LocalBusiness',
        name: 'Office Factory',
        address: {
...
export default function DomiciliationStartupPage() {
    const t = useTranslations('DomiciliationStartupPage');
    return (
        <main className="min-h-screen flex flex-col bg-white">
            <script
                type="application/ld+json"
                dangerouslySetInnerHTML={{ __html: JSON.stringify(domiciliationStartupServiceSchema) }}
            />
            <Navbar />
            ...
            <section className="pt-32 pb-20 bg-[#F8F9FA]">
                <div className="container grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative h-[400px] w-full rounded-3xl overflow-hidden shadow-2xl">
                        <Image
                            src="/letterbox.jpg"
                            alt="Office Factory - Domiciliation pour startups"
                            fill
            ...
            {/* Why Your Startup Needs a Registered Office */}
