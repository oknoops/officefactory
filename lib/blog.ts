...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    category: 'legal',
    date: '2026-03-23',
    image: '/documents-domicilier-entreprise.jpg',
  ...
  {
    id: 'domiciliation-vs-bureau-virtuel',
    slugs: {
      fr: 'domiciliation-vs-bureau-virtuel-quelle-difference',
      en: 'domiciliation-vs-virtual-office-what-is-the-difference',
      nl: 'domiciliering-vs-virtueel-kantoor-wat-is-het-verschil',
    },
    category: 'guides',
    date: '2026-04-27',
    image: '/blog-domiciliation-vs-virtuel.jpg',
    translationNamespace: 'BlogPost15',
    metadataKey: 'blog_post15',
    conclusionLinkHref: '/services/domiciliation-virtuelle',
    sections: [
      { type: 'text', id: 'definition-domiciliation', tocKey: 'toc_domiciliation', titleKey: 'domiciliation_title', contentKey: 'domiciliation_content' },
      { type: 'text', id: 'definition-virtual', tocKey: 'toc_virtual', titleKey: 'virtual_title', contentKey: 'virtual_content' },
      { type: 'text', id: 'key-differences', tocKey: 'toc_differences', titleKey: 'differences_title', contentKey: 'differences_content' },
      { type: 'text', id: 'legal', tocKey: 'toc_legal', titleKey: 'legal_title', contentKey: 'legal_content' },
      { type: 'text', id: 'which-to-choose', tocKey: 'toc_choice', titleKey: 'choice_title', contentKey: 'choice_content' },
    ],
  },
  {
    id: 'creer-entreprise-belgique-guide',
    slugs: {
      fr: 'comment-creer-entreprise-belgique-guide-complet',
      en: 'how-to-start-company-belgium-complete-guide',
      nl: 'hoe-bedrijf-oprichten-belgie-complete-gids',
    },
    category: 'guides',
    date: '2026-04-27',
    image: '/blog-creer-entreprise-belgique.jpg',
    translationNamespace: 'BlogPost16',
    metadataKey: 'blog_post16',
    conclusionLinkHref: '/services/domiciliation-bruxelles',
    sections: [
      { type: 'text', id: 'before-you-start', tocKey: 'toc_before', titleKey: 'before_title', contentKey: 'before_content' },
      { type: 'text', id: 'legal-form', tocKey: 'toc_form', titleKey: 'form_title', contentKey: 'form_content' },
      { type: 'steps', id: 'steps', tocKey: 'toc_steps', titleKey: 'steps_title', introKey: 'steps_intro', count: 7, linkKey: 'steps_link', linkHref: '/services/demarches-administratives' },
      { type: 'text', id: 'costs', tocKey: 'toc_costs', titleKey: 'costs_title', contentKey: 'costs_content' },
      { type: 'text', id: 'registered-office', tocKey: 'toc_office', titleKey: 'office_title', contentKey: 'office_content' },
      { type: 'text', id: 'expat-tips', tocKey: 'toc_expat', titleKey: 'expat_title', contentKey: 'expat_content' },
    ],
  },
];
